...
class ClientCore<State, Data> {
  ClientCore({
    ...
    List<EventClientInPreCore<Data>>? initialEvents,
  ...
  State _bakedState;
  List<EventClientInPreCore<Data>> _initialEvents;
  ...
  void _addEvent(EventClientInPreCore<Data> preCoreEvent) {
    ...
    if ((preCoreEvent is EventClientInFromServer<Data> &&
      ...
      print(
          'ERROR: Event added is too old (past latency cutoff): ${preCoreEvent.toShortString()}');
      return;
    ...
    final EventClientInInCore<Data> inCoreEvent = switch (preCoreEvent) {
      ...
      EventClientInFromLocalPreCoreDebug<Data>() =>
        EventClientInFromLocalInCore<Data>(
          generatedTimestamp: preCoreEvent.generatedTimestamp,
          data: preCoreEvent.data,
          senderID: preCoreEvent.senderID,
          eventID: preCoreEvent.eventID,
        )
    };
